...
let botonesMas = document.getElementById('Mas')
    botonesMas.addEventListener('click', consologearMas)
    function consologearMas(){
        console.log('click +')
    }
let botonesMenos = document.getElementById('Menos')
    botonesMenos.addEventListener('click', consologearMenos)
    function consologearMenos(){
        console.log('click -')
    }
